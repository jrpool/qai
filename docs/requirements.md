...
QAI should explain and show a literate but nontechnical user how to connect LLMs to tools:

- on the `claude.ai` AI platform
...
The system needs to capture any user comments and permit the maintainer to:
...
The system should conform to the current TypeScript, HTML5, and CSS3 specifications.
...
- cover AI platforms other than `claude.ai`
